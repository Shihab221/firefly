...
const page = () => {
  return (
    <div className=' px-10 sm:px-20 flex flex-col sm:flex-row gap-6 py-5 '>
      <div className="bg-white w-full sm:w-2/3 border p-6  shadow-md mx-auto">
        <h2 className="text-2xl font-semibold  mb-4 font-orbitron text-emerald-500">Book Your Project</h2>
